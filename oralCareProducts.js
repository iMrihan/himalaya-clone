...
function sortHandle(e) {
  ...
  if (value == "nameAscending") {
    oralCareData.sort(function (a, b) {
...
function displayItems(oralCareData) {
  document.querySelector(".product-image-link-right").textContent = "";

  oralCareData.map(function (elem) {
